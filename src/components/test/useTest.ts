    ...
    const init = () => {
        ...
        window.DispatchAction(ActionTypes.SET_SETTINGS, {
            settings: {
                ...
                selectedResolution: 181,
                screens: 3,
                selectedScreen: 0,
                fullscreen: false,
                masterVolume: 0.6162790060043335,
                musicVolume: 0.699999988079071,
                    ...
                    'vu-battleroyale': {
                        Voip_Team_TransmissionMode: {
                            ...
                            value: {
                                value: 'PushToTalk',
                                allowEmpty: false,
                                options: ['AlwaysOn', 'PushToTalk', 'VoiceActivation'],
                            },
                        },
                        ...
                        PingEnemyOption: {
                            ...
                            value: {
                                ...
                                allowEmpty: false,
                                options: ['Define MouseButton', 'Define Key', 'Press Ping-Key twice'],
                            },
                        },
                        PingEnemyKey: {
                            type: 2,
